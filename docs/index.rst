...
``EIR-auto-GP`` is a Python package
for automated genomic prediction (GP)
using deep learning models with EIR.
...
First, ensure that `plink2 <https://www.cog-genomics.org/plink/2.0/>`_
