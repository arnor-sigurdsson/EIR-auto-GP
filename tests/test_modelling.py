...
def _get_test_cl_commands() -> list[str]:
    ...
    feature_selections = [
        ...
        "--feature_selection dl --n_dl_feature_selection_folds 1 ",
        "--feature_selection gwas->dl --n_dl_feature_selection_folds 1 ",
    ]
...
def check_average_performances(file_path: Path, threshold: float = 0.7) -> None:
